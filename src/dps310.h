...
/******************************************************************************
* @brief registers for configuration and flags; these are the same for both 310
* and 422, might need to be adapted for future sensors
********************************************************************************/
...
void print_app_events(cy_stc_pdstack_context_t* ctx, cy_en_pdstack_app_evt_t evt);
